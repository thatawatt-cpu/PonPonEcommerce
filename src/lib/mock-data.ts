...
export const mockOrderTimeline: OrderTimelineStep[] = [
  ...
  { key: "waiting", label: "รอตรวจสอบการชำระเงิน", state: "active", at: "8 มิ.ย. 2569 10:31" },
  { key: "packed", label: "กำลังเตรียมสินค้า", state: "pending" },
  { key: "shipping", label: "จัดส่งแล้ว", state: "pending" },
  { key: "success", label: "สำเร็จ", state: "pending" },
];
...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { key: "waiting", label: "รอตรวจสอบการชำระเงิน", state: "completed", at: "5 มิ.ย. 2569 09:12" },
      { key: "packed", label: "กำลังเตรียมสินค้า", state: "completed", at: "6 มิ.ย. 2569 14:20" },
      { key: "shipping", label: "จัดส่งแล้ว", state: "active", at: "7 มิ.ย. 2569 08:45" },
      { key: "success", label: "สำเร็จ", state: "pending" },
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      { key: "waiting", label: "รอตรวจสอบการชำระเงิน", state: "completed", at: "28 พ.ค. 2569 13:20" },
      { key: "packed", label: "กำลังเตรียมสินค้า", state: "completed", at: "29 พ.ค. 2569 10:30" },
      { key: "shipping", label: "จัดส่งแล้ว", state: "completed", at: "30 พ.ค. 2569 09:20" },
      { key: "success", label: "สำเร็จ", state: "active", at: "31 พ.ค. 2569 16:45" },
    ],
  ...
  },
  {
    ...
    timeline: [
      ...
      { key: "voided", label: "ยกเลิก", state: "active", at: "20 พ.ค. 2569 19:10" },
    ],
